...
There is no single "best" land cover product. Every option sits somewhere on a tradeoff between four axes that cannot all be maximised at once:

- **Spatial resolution** (pixel/polygon size)
- **Thematic detail** (number and granularity of classes)
- **Accuracy** (validated overall accuracy / geometric fidelity)
- **Coverage + currency + cost** (how much of the world, how often, free vs paid)
...
## 9. Synthesis — most accurate vs most detailed vs most ecological
...
- Switzerland: **AV Bodenbedeckung** (surveyed, cm-level).
